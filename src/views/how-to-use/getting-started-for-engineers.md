...
The Code for America, U. S. Web Design System (USWDS) theme replaces the Honeycrisp Ruby gem but preserves the style and design. The theme uses “design tokens” from the Honeycrisp design system to make the USWDS look similar to Honeycrisp. On this site, engineers can reference documentation for component replacements.
